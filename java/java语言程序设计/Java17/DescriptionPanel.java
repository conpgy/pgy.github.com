...
public class DescriptionPanel extends JPanel
{
	...
	{
		//Center the icon and text and placethe text under the icon
		...
		jlblImageTitle.setFont(new Font("SanSerif", Font.BOLD, 16));
		jtaDescription.setFont(new Font("Serif", Font.PLAIN, 14));

		//Set lineWrap and wrapStyleWorld true for the text area
