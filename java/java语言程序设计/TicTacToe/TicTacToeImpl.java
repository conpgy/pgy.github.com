...
{
	// Deleare two players, used to call players back
	 ...
	 * If the returned token is ' ', the client is not connected to the server
	 * */
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Registry registry = LocateRegistry.getRegistry("123.14.132.55");
