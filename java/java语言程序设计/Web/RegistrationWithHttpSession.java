...
public class RegistrationWithHttpSession extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		Student student = new Student(lastName, firstName, mi, telephone, email, street, city, state, zip);
		...
		// Set the action for procession the answers
		out.println("<p><form method = \"post\" action = http://localhost:8080/pgyweb/RegistrationWithHttpSession>");
	...
	{
		// Set response type and output stream to the broser
		response.setContentType("text/html");
		PrintWriter out = response.getWriter();
		...
		try
		{
			...
			out.println(student.firstName + " " + student.lastName + " is now registered in the database");
			out.close();
		}
		catch(Exception ex)
		{
	...
	class Student
	{
		...
		Student(String lastName, String firstName, String mi, String telephone, String email, String street,
