public class MyArrayList extends MyAbstractList
{
	...
	/** Return the element from this list at the specified inedx */
	...
	/** Return the index of the last matching element inthis list
	 *  Return -1 if no match */
	 ...
	 *  Return the element that was reomoved from the list. */
