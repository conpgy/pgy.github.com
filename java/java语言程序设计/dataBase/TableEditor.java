...
public class TableEditor extends JPanel
{
	...
	public TableEditor()
	{
		...
		jPane1.add(jbtPrior);
		jPane1.add(jbtLast);
		jPane1.add(jbtInsert);
		jPane1.add(jbtDelete);
		jPane1.add(jbtUpdate);

		add(jPane1, BorderLayout.NORTH);
	...
	private void delete()
	{
		try
		{
			// Delete the rrecord from the database
			resultSet.deleteRow();
			refreshResultSet();
