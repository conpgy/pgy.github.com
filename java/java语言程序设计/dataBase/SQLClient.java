...
public class SQLClient extends JApplet
{
	...
	// JDBC info for a databsse connection
	JTextField jtfUsername = new JTextField();
	JPasswordField jpfPassword = new JPasswordField();
	JComboBox jcboURL = new JComboBox(new String[] {"jdbc:mysql://liang.armstrong.edu/test", "jdbc:odbc:exampleMDBDataSource"
	...
	Border titleBorder3 = new TitledBorder("Enter Database Information");
	...
	public void init()
	{
		...
		jScrollPane1.setBorder(titleBorder1);
		JScrollPane jScrollPane2 = new JScrollPane(jtaSQLResult);
		jScrollPane2.setBorder(titleBorder2);
		...
		jPanel6.setBorder(titleBorder3);
