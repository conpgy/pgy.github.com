...
public class CopyFileToTable extends JFrame
{
	...
	private JButton jbtViewFile = new JButton("ViewFile");
	...
	private void copyFile() throws Exception
	{
		...
		// Read each line from teh text file and insert it to the table
		insertRows(conn);
	}

	private void insertRows(Connection connection)
	{
		// Build teh SQL INSERT statement
		...
		try
		{
			...
			// Determine if batchUpdatesSupproted is supported
			...
			{
				// Read a line and add the insert table command to teh batch
				while(input.hasNext())
				{
	...
	public static void main(String[] args)
	{
		...
		frame.setTitle("Copy file to table");
